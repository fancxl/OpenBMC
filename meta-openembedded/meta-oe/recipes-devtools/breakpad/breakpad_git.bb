...
SRC_URI = "https://github.com/google/breakpad;name=breakpad;branch=main \
           https://github.com/google/googletest.git;destsuffix=git/src/testing/gtest;name=gtest \
           https://github.com/protocolbuffers/protobuf.git;destsuffix=git/src/third_party/protobuf/protobuf;name=protobuf \
           https://chromium.googlesource.com/linux-syscall-support;protocol=https;branch=main;destsuffix=git/src/third_party/lss;name=lss \
           https://chromium.googlesource.com/external/gyp;protocol=https;destsuffix=git/src/tools/gyp;name=gyp \
